<script>
    ...
    export let data
    let user_link = `http://bikol.vm.wmi.amu.edu.pl/dtin/results/${ data.indeks }`
    let user_results = []
    let tasks = []
    ...
    <div class="flex">
        <div class="left-column w-1/6">
            <div class="flex items-center justify-center w-40 mt-2 mb-4"> 
                <p class="text-3xl text-light font-light"><span class="font-semibold text-white">{ data.indeks }</span></p>
            </div>
